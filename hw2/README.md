...
Для анализа выбрал страничку про Римскую Империю: `https://en.wikipedia.org/wiki/Roman_Empire`
...
# Задание 5
Создал телеграм бота и добавил нужные штуки в `.githiub/workflows/PR-tg-notify.yaml`. 

Жду PR и прикреплю скрин (ну надеюсь сообщение придет ахах)
